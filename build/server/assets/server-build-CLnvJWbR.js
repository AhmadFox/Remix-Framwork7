...
function AppLayout({ children = null }) {
  ...
  const url = `${"http://localhost:5173"}${path.pathname}`;
  useEffect(() => {
    setIsClient(true);
    Framework7.use(Framework7React);
